...
#define PIN5 GPIO(0,25)
#define PIN6 GPIO(0,26)
#define PIN7 GPIO(0,27)
#define PIN8 GPIO(0,28)
#define PIN9 GPIO(0,29)
#define PIN10 GPIO(0,30)
#define PIN11 GPIO(0,15)
#define PIN12 GPIO(0,16)

#define PIN13 GPIO(0,11)
#define PIN14 GPIO(0,13)
#define PIN15 GPIO(0,14)
#define PIN16 GPIO(0,12)
#define PIN17 GPIO(0,2)
#define PIN18 GPIO(0,3)
#define PIN19 GPIO(0,4)

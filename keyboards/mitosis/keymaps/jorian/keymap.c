...
#undef LAYOUT
#define LAYOUT LAYOUT_jorian

// see Jian layout here: http://www.keyboard-layout-editor.com/#/gists/4b6c2af67148f58ddd6c6b2976c4370f
...
[_ADJUST] = LAYOUT(\
  RESET,   DEBUG,   KC_ASUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ASUP, DEBUG,   RESET, \
           ...
           XXXXXXX, KC_ASDN, XXXXXXX, XXXXXXX, TG_ISO,  TG_THMB,      TG_THMB, TG_ISO,  XXXXXXX, XXXXXXX, KC_ASDN, XXXXXXX, \
                                      _______, _______,   _______,      _______, _______,   _______\
),

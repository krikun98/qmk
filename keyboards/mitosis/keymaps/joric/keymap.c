...
#define LAYER_TOGGLE_DELAY 300000
...
[_MALT] = { /* Default Layout, customised for reduced columns (ex: quote and shift locations) */
  {KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,           KC_Y,    KC_U,    KC_I,    KC_O,    KC_P    },
  {KC_A,    KC_S,    KC_D,    KC_F,    KC_G,           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN },
  {KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH },
  {XXXXXXX, KC_LCTL, KC_LALT, SHIFT,   KC_LGUI,        KC_ENT,  SHIFT,   KC_LBRC, KC_RBRC, XXXXXXX },
  {XXXXXXX, KC_ESC,  KC_TAB,  FNKEY,   KC_BSPC,        KC_SPC,  FNKEY,   KC_BSLS, KC_EQL,  XXXXXXX }
},
...
[_FUNCTION] = { /* Function Layer, primary alternative layer featuring numpad on right hand,
  ...
  {XXXXXXX, _______, _______, _______,  KC_MENU,       KC_PSCR, _______, KC_F9,   KC_F10,  XXXXXXX },
  {XXXXXXX, KC_GRV,  KC_CAPS, _______,  KC_DEL,        KC_PAUS, _______, KC_F11,  KC_F12,  XXXXXXX }
},
